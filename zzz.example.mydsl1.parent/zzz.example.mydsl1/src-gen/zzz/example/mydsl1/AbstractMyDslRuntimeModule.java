...
import zzz.example.mydsl1.generator.MyDslGenerator;
import zzz.example.mydsl1.parser.antlr.MyDslAntlrTokenFileProvider;
import zzz.example.mydsl1.parser.antlr.MyDslParser;
import zzz.example.mydsl1.parser.antlr.internal.InternalMyDslLexer;
import zzz.example.mydsl1.scoping.MyDslScopeProvider;
import zzz.example.mydsl1.serializer.MyDslSemanticSequencer;
import zzz.example.mydsl1.serializer.MyDslSyntacticSequencer;
import zzz.example.mydsl1.services.MyDslGrammarAccess;
import zzz.example.mydsl1.validation.MyDslConfigurableIssueCodesProvider;
import zzz.example.mydsl1.validation.MyDslValidator;
...
public abstract class AbstractMyDslRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "zzz/example/mydsl1/MyDsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("zzz.example.mydsl1.MyDsl");
	}
